 ...
 */
public class FragmentSymptomsVideo extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_symptoms_video, container, false);
        ...
        mVideosRef = mRootRef.child(MyConstants.DB_REF_SYMPTOMS).child(MyConstants.DB_REF_VIDEOS);
        Log.d("xyz","at_risk-videos ref :"+mVideosRef.toString());      //logging path
