 ...
 */
public class FragmentSymptomsImage extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_fragment_symptoms_image, container, false);
        /*** initializing components ***/
        //views
        recyclerView = (RecyclerView) view.findViewById(R.id.rv_symptoms_image);
        ...
        mImagesRef = mRootRef.child(MyConstants.DB_REF_SYMPTOMS).child(MyConstants.DB_REF_IMAGES);
        Log.d("xyz", "symptoms-images ref :" + mImagesRef.toString());      //logging path
