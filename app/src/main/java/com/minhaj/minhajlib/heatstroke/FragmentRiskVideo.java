 ...
 */
public class FragmentRiskVideo extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_fragment_risk_video, container, false);
        ...
        mVideosRef = mRootRef.child(MyConstants.DB_REF_AT_RISK).child(MyConstants.DB_REF_VIDEOS);
