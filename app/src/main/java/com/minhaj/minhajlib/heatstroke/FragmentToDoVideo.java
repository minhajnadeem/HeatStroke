 ...
 */
public class FragmentToDoVideo extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_to_do_video, container, false);
        ...
        mVideosRef = mRootRef.child(MyConstants.DB_REF_TO_DO).child(MyConstants.DB_REF_VIDEOS);
        Log.d("xyz","to do-videos ref :"+mVideosRef.toString());      //logging path
