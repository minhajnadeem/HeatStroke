 ...
 */
public class WhatIsVideo extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_what_is_video, container, false);
        ...
        mVideosRef = mRootRef.child(MyConstants.DB_REF_WHAT_IS).child(MyConstants.DB_REF_VIDEOS);
        Log.d("xyz","what is-videos ref :"+mVideosRef.toString());      //logging path
    ...
    public void onStart() {
        super.onStart();
        arrListVideoModal.clear();  //clear array list when attaching listener
