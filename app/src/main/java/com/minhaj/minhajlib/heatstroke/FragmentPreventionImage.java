 ...
 */
public class FragmentPreventionImage extends Fragment {
    ...
    public FragmentPreventionImage() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_prevention_image, container, false);
        ...
        mImagesRef = mRootRef.child(MyConstants.DB_REF_PREVENTION).child(MyConstants.DB_REF_IMAGES);
        Log.d("xyz", "prevention-images ref :" + mImagesRef.toString());      //logging path
