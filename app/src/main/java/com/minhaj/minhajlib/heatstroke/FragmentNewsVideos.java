 ...
 */
public class FragmentNewsVideos extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_news_videos, container, false);
        ...
        mVideosRef = mRootRef.child(MyConstants.DB_REF_NEWS).child(MyConstants.DB_REF_VIDEOS);
